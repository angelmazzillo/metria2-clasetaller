...
expocolombia = pd.read_excel("ExpoColombia1844-2024.xlsx")
...
# Por tanto, se propone inicialmente un modelo ARMA(1,1) sobre la serie
# transformada, equivalente a un ARIMA(1, 1, 1)
...
plot_acf(residuos, lags=24, alpha=0.05, bartlett_confint=False)
...
plot_acf((residuos) ** 2, lags=24, alpha=0.05, bartlett_confint=False)
...
# %% 2. Prueba sobre la serie diferenciada
